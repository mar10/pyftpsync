# -*- coding: utf-8 -*-
#
# pyftpsync documentation build configuration file, created by
...
project = u'pyftpsync'
copyright = u'2012-2019, Martin Wendt'
...
htmlhelp_basename = 'pyftpsyncdoc'
...
latex_documents = [
  (master_doc, 'pyftpsync.tex', u'pyftpsync Documentation',
...
man_pages = [
    (master_doc, 'pyftpsync', u'pyftpsync Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pyftpsync', u'pyftpsync Documentation',
   author, 'pyftpsync', 'One line description of project.',
   'Miscellaneous'),
]
